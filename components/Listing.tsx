export const Listing = () => {
  return (
    <section className="body-font overflow-hidden text-gray-600 pt-12 pb-40">
      <div className="container mx-auto px-5 py-24">
        <div className="-m-12 flex flex-wrap">
          <div className="flex flex-col items-start p-12 md:w-1/2">
            <span className="inline-block rounded bg-pink-50 py-1 px-2 text-xs font-medium tracking-widest text-pink-500">
              Fullstack
            </span>
            <h2 className="title-font mt-4 mb-4 text-2xl font-medium text-gray-900 sm:text-3xl">
              Fullstack engineer for OwlDAO
            </h2>
            ...
            <div className="mb-4 mt-auto flex w-full flex-wrap items-center border-b-2 border-gray-100 pb-4">
              <a className="inline-flex items-center text-pink-500">
                Talk
                <svg
              ...
              <span className="mr-3 ml-auto inline-flex items-center border-r-2 border-gray-200 py-1 pr-3 text-sm leading-none text-gray-400">
                <svg
